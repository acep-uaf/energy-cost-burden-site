DROP TABLE IF EXISTS public.eielson_winter;
CREATE TABLE public.eielson_winter AS
WITH
...
DROP TABLE IF EXISTS public.wainwright_winter;
CREATE TABLE public.wainwright_winter AS
WITH
